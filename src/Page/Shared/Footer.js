  ...
  return (
    <footer id='Footer' className='footer'>
        ...
        <div className='row'>
          <div className='col-md-4 mb-4'>
            ...
            <p className='footer-description'>
              Spring BD Knitwear LTD is a lifestyle that brings together a journey enriched by history,
          ...
          <div className='col-md-4 mb-4 px-md-5'>
            <h5 className="footer-heading">Spring BD Knitwear LTD</h5>
          ...
          <div className='col-md-4 mb-4'>
            ...
            <p><MdEmail /> hasan@spring-knitwearbd.com</p>
      ...
      <div className='footer-bottom'>
        <p>&copy; {currentYear} Spring BD Knitwear LTD. All rights reserved.</p>
      </div>
    </footer>
  );
};
